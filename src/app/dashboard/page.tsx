  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA]">
      ...
      <div className="bg-white border-b border-[#eee]">
        <div className="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <span className="text-[13px] text-[#888]">{user.email}</span>
      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        <h1 className="font-['Cormorant_Garamond'] text-[36px] text-[#1a1a1a] mb-2">
        ...
        {courses.length > 0 ? (
          <div className="grid md:grid-cols-2 gap-4">
            {courses.map(course => (
              <a
                ...
                className="block bg-white rounded-2xl p-6 border border-[#eee] hover:border-[#D4AF37] hover:shadow-sm transition"
              >
                <h3 className="font-semibold text-[16px] mb-2">{course.title}</h3>
                {course.short_description && (
                  <p className="text-[13px] text-[#888] mb-3">{course.short_description}</p>
                )}
          ...
          <div className="bg-white rounded-2xl p-8 border border-[#eee] text-center">
            ...
            <a
              href="/pricing"
              className="inline-block px-8 py-3 rounded-full bg-[#D4AF37] text-white font-semibold text-[14px] hover:bg-[#C5A028] transition"
            >
              Bekijk cursussen
            </a>
          </div>
