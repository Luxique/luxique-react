      ...
      <div ref={rootRef}>
        <style>{`
          ...
          @media(max-width:860px){
            ...
            .about-page .portrait{max-width:100%;margin:0 auto;width:100%;min-height:400px;aspect-ratio:4/5;order:-1}
            .about-page .intro-grid .portrait{grid-row:1}
            .about-page .portrait .img,.about-page .portrait img{width:100% !important;height:100% !important;object-fit:cover !important}
          ...
          <section className="intro">
            <div className="wrap intro-grid">
              <div className="portrait clip">
                <img src="https://osldoolmbpqayxhgmbum.supabase.co/storage/v1/render/image/public/images/about-us-profile.webp?width=900&quality=75&resize=contain" alt="Chiva Daams" style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover' }} />
