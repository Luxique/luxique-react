...
export default function Home() {
  return (
    ...
    <>
      ...
      <Reveal><div id="academy" data-theme-color="#0e0b09" data-theme-dark="true" style={{ background: 'radial-gradient(110% 70% at 50% -8%, rgba(176,141,79,.12), transparent 60%), linear-gradient(180deg, #0e0b09, #0e0b09 75%)', padding: 'clamp(120px,12vw,160px) 0 clamp(20px,3vw,28px)' }}><div className="max-w-[1180px] mx-auto px-[28px]">
        ...
        <ComparisonTable theme="dark" /><AcademyHomeSection /></div></div></Reveal>
