  ...
  return (
    <section className="px-[14px] max-[860px]:px-[10px] flex flex-col gap-[14px]">
      ...
      <div className="rounded-[22px] bg-[#161310] relative min-[860px]:overflow-visible overflow-hidden min-h-[420px] max-[860px]:min-h-0 flex items-end">
        ...
        {/* Portrait — feet at exact bottom, head bleeds above panel on desktop */}
        <div className="absolute left-[40px] bottom-0 z-[3] min-[860px]:w-[480px] min-[860px]:-top-[80px] max-[860px]:left-1/2 max-[860px]:w-[75%] max-[860px]:max-w-[300px] max-[860px]:translate-x-[-50%]">
