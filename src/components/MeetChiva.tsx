  ...
  return (
    <section className="px-[14px] max-[860px]:px-[10px] flex flex-col gap-[14px]">
      ...
      <div className="rounded-[22px] bg-[#161310] relative overflow-hidden min-h-[420px] max-[860px]:min-h-[380px] max-[540px]:min-h-[340px] flex items-end">
        ...
        <div
          className="absolute bottom-0 top-auto z-[3] left-[160px] w-[320px] max-[860px]:left-auto max-[860px]:right-0 max-[860px]:w-[55%] max-[860px]:max-w-[300px] max-[860px]:-top-[60px]"
        ...
        <div className="relative z-[4] min-[860px]:ml-[540px] max-[860px]:pt-3 max-[860px]:px-6 min-[860px]:py-12 min-[860px]:pr-12 flex-1 flex flex-col min-[860px]:justify-end gap-4 max-[860px]:items-start max-[860px]:text-left">
