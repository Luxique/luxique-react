...
export default function TechVsArtist() {
  const t = useTranslations('TechVsArtist')
          ...
          <div className="tva-cards">
            ...
            <article className="tva-card card--tech">
              <div className="card-media">
                <img src="https://osldoolmbpqayxhgmbum.supabase.co/storage/v1/render/image/public/images/tva-lash-tech.webp?width=1300&quality=75" alt="Lash Technician" />
              </div>
              <div className="card-body">
                <h3>{t('techLabel')}</h3>
                <p>{t('techDescription1')}</p>
                <p>{t('techDescription2')}</p>
                <div className="card-foot"><span className="foot-note">{t('techFooter')}</span></div>
              </div>
            </article>
            ...
            <article className="tva-card card--artist">
              <div className="card-media">
                ...
                <img src="https://osldoolmbpqayxhgmbum.supabase.co/storage/v1/render/image/public/images/tva-lash-artist.webp?width=1300&quality=75" alt="Lash Artist" />
              </div>
              <div className="card-body">
                <h3>{t('artistLabel')}</h3>
                <p className="lede">{t('artistHeadline')}</p>
                <p>{t('artistDescription')}</p>
                <div className="card-foot">
                  <a className="tva-btn" href="/courses">{t('artistCta')}
            ...
            <div className="tva-vs">{t('vsText')}</div>
          </div>
          ...
          <figure className="quote-block">
            ...
            <div className="quote-body">
              ...
              <figcaption className="quote-cite">
                <span className="quote-name">{t('quoteName')}</span>
                <span className="quote-role">{t('quoteRole')}</span>
              </figcaption>
            </div>
          </figure>
        </div>
