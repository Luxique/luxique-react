  ...
  return (
    <>
      <style>{`
        ...
        .ck-banner{position:fixed;left:24px;top:16px;z-index:9998;width:min(440px,calc(100vw - 48px));background:radial-gradient(120% 130% at 0% 0%,rgba(176,141,79,.1),transparent 55%),#FBF8F2;border:1px solid rgba(28,24,20,.14);border-radius:18px;box-shadow:0 30px 70px -24px rgba(28,24,20,.4),0 0 0 1px rgba(176,141,79,.08);padding:24px 24px 20px;transform:translateY(-140%);opacity:0;transition:transform .5s cubic-bezier(.16,1,.3,1),opacity .5s;font-family:'Jost',system-ui,sans-serif}
